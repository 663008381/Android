...
public class NoteEditor extends Activity {
    ...
    private static final String[] PROJECTION =
        new String[] {
            NotePad.Notes._ID,
            NotePad.Notes.COLUMN_NAME_MODIFICATION_DATE,//TODO 修改
    ...
    private int mState;
    private Uri mUri;
    private Cursor mCursor; //https://blog.csdn.net/yours2/article/details/52073790
...
//END_INCLUDE(paste)
    ...
    private final void cancelNote() {
        if (mCursor != null) {
            if (mState == STATE_EDIT) {
                ...
                values.put(NotePad.Notes.COLUMN_NAME_MODIFICATION_DATE, getFormatData());//TODO 修改：退出note自动更新时也更新时间戳
    ...
    private final void deleteNote() {
        if (mCursor != null) {
            mCursor.close();
            mCursor = null;
            //getContentResolver简介：https://www.cnblogs.com/tiejiangweigaibianercunzai/articles/3795628.html
